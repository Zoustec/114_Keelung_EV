...
import PowerStationInfo from "./pages/Map/PowerStationInfo";
import SubsidyIntro from "./pages/Subsidy";
import TeenSubsidyIntro from "./pages/TeenSubsidy";
import Description from "./pages/Description";
import Download from "./pages/Download";
import PolicyEffect from "./pages/PolicyEffect";
import SuccessCase from "./pages/SuccessCase";
import DMDownload from "./pages/Download/DMDownload";
...
const routes = [
  ...
  { path: "/news", breadcrumbName: "座談會資訊", element: <Seminar /> },
  { path: "/seminar", breadcrumbName: "座談會資訊", element: <Seminar /> },
  { path: "/training", breadcrumbName: "培訓課程資訊", element: <Training /> },
  { path: "/lottery", breadcrumbName: "抽獎活動資訊", element: <Lottery /> },
  { path: "/policy-effect", breadcrumbName: "車行轉型成效", element: <PolicyEffect /> },
