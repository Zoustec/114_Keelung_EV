...
//若查詢對象不在是統編和手機，AppScirpt裡面的也要改

export default function TeenSubsidyIntro() {
  ...
  return (
    <div className="py-[42px] flex justify-center items-center w-full">
      <div className=" w-[100vw] md:w-[80vw] flex justify-center items-center">
        {/* 主要卡片容器 */}
        <div className="bg-white flex flex-col items-center w-4/5 rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.2)] p-2 md:p-8">
          {/* 標題區域 */}
